...
- The Monthly Collection and Today's Collection KPI cards display unweighted rupee totals from `collections_messages.amount_collected` for the same anchored monthly/daily periods. Recent collection cards also display the row's exact rupee amount as their primary value. Daily/monthly top performers, the leaderboard, and celebration qualification remain based on weighted points.
